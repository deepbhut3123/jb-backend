...
const productSchema = new mongoose.Schema(
  {
    ...
    dollarAmount: { type: Number, min: 0, default: 0 },
    convertedAmount: { type: Number, min: 0, default: 0 },
    finalRate: { type: Number, min: 0, default: 0 },
    dollarRate: { type: Number, min: 0, default: 1 },
    marginPercent: { type: Number, min: 0, default: 0 },
    priceMultiplier: { type: Number, min: 0, default: 1 },
